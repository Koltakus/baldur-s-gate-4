...
print('Выберите класс своего персонажа,' + player2_name + '!' + '\nВыбери из предложенных ниже классов')
print('Warrior'+'\nRouge'+'\nWizard')
player2_class = input()
def player2_class_choice(player_class):
    if player_class == 'Warrior':
        player_class = 'Warrior'
    elif player_class == 'Rogue':
        player_class = 'Rogue'
...
player2_class = player2_class_choice(player2_class)

print(player2_name + ', ты выбрал класс ' + player2_class+'.' + '\nТы уверен в своем выборе?' + '\nДа/Нет?')
